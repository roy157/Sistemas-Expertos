...
class Nodo():
    def __init__(self, estado, padre, accion, heuristica=0):
        self.estado = estado
        self.padre = padre
        self.accion = accion
...
class Laberinto():
    ...
    def solve(self):
        ...
        inicio = Nodo(estado=self.inicio, padre=None, accion=None, heuristica=h(self.inicio))
        ...
        while frontera:
            ...
            frontera.sort(key=lambda n: n.heuristica)
            ...
            for accion, estado in self.vecinos(nodo.estado):
                if estado not in self.explorado and estado not in [n.estado for n in frontera]:
                    ...
                    hijo = Nodo(estado=estado, padre=nodo, accion=accion, heuristica=heuristica_hijo)
