...
letraChica = pygame.font.Font("/Applications/XAMPP/xamppfiles/htdocs/PHYTON_2025/OpenSans-Regular.ttf", 28)
letraGrande = pygame.font.Font("/Applications/XAMPP/xamppfiles/htdocs/PHYTON_2025/OpenSans-Regular.ttf", 40)
letraMovimiento = pygame.font.Font("/Applications/XAMPP/xamppfiles/htdocs/PHYTON_2025/OpenSans-Regular.ttf", 60)
...
while True:
    ...
    if usuario is None:
        ...
        if usuario != jugador and not ggwp:
        ...
        click, _, _ = pygame.mouse.get_pressed()
        if click == 1 and usuario == jugador and not ggwp:
            mouse = pygame.mouse.get_pos()
            for i in range(3):
                for j in range(3):
